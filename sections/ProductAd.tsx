...
export default function ProductAd(props: Props) {
    ...
    return (
        <div id={id} class={`relative flex flex-col ${vertical ? "md:flex-col max-w-[310px]" : "md:flex-row"} justify-between items-center border rounded p-2 bg-[#f5f5f5] w-full md:w-fit`}>
...
export function LoadingFallback() {
    return <ProductAd product={{ image: "https://placehold.co/300x300", title: "loading...", description: "loading...", price: "Loading" }} adDescription="loading..." />
}
